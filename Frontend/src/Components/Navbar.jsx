                ...
                <div className='max-w-screen-2x1 container mx-auto md:px-20 px-4 dark:bg-cyan-950 bg-[#f8f7f3]'>
                    <div className="navbar ">
                        <div className="navbar-start">
                            ...
                            <a className="text-2xl font-bold cursor-pointer">Page<span className='text-orange-500'>Turner</span></a>
                        </div>
                        <div className="navbar-end space-x-3">
                            ...
                            <div className="">
                                <a
                                    className="bg-orange-500 text-white px-3 py-2 rounded-md hover:bg-slate-900 duration-300 cursor-pointer"
                                    onClick={() => 
